                                    ...
                                    <form class="mx-1 mx-md-4" method="post" action="{{route('register')}}">
                                        ...
                                        <div class="d-flex flex-row align-items-center mb-4">
                                            ...
                                            <div class="form-outline flex-fill mb-0">
                                                ...
                                                <input type="text" id="form3Example1c" class="form-control" name="name" id="name" value="{{old('name')}}"/>
                                        ...
                                        <div class="d-flex flex-row align-items-center mb-4">
                                            ...
                                            <div class="form-outline flex-fill mb-0">
                                                ...
                                                <input type="email" id="form3Example3c" class="form-control" name="email" id="email" value="{{old('email')}}"/>
